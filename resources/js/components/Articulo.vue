        ...
        methods : {
            ...
            desactivarArticulo(id){
                const swalWithBootstrapButtons = Swal.mixin({
                    ...
                    title: 'Estas seguro?',
                    text: "De que deseas desactivar el registro!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(function () {
                            ...
                            swalWithBootstrapButtons.fire(
                                'Desactivada!',
                                'El registro fue desactivado con éxito.',
                                'success'
                            )
                        });
                        ...
                        swalWithBootstrapButtons.fire(
                        'Cancelado',
                        'La desactivacion fue cancelada:)',
                        'error'
                        )
                    }
                    })
            ...
            activarArticulo(id){
                const swalWithBootstrapButtons = Swal.mixin({
                    ...
                    swalWithBootstrapButtons.fire({
                    title: 'Estas seguro?',
                    text: "De que deseas activar el registro!",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Aceptar!',
                    cancelButtonText: 'Cancelar!',
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(function () {
                            ...
                            swalWithBootstrapButtons.fire(
                                'Activada!',
                                'El registro fue activado con éxito.',
                                'success'
                            )
                        });
            ...
            validarArticulo(){
                ...
                if (!this.precio_venta) {
                    this.errorMostrarMsjArticulo.push("El precio de venta del articulo debe de ser un numero y no puede estra vacio.");
                }

                if (!this.stock) {
                    this.errorMostrarMsjArticulo.push("El stock del articulo debe de ser un numero y no puede estra vacio.");
                }
